 ...
 * @author Server
 */
public class VFD extends Com
{

    SettingsDAO settingsDAO = new SettingsDAO();

    private ComType type = ComType.VFD;
    private String name = DefinedVariables.getInstance().SETTING_COM_VFD;
    ...
    public boolean loadStatus()
    {
        ...
        String type = settingsDAO.getSetting(DefinedVariables.getInstance().SETTING_COM_VFD_USE);
        String connect = settingsDAO.getSetting(DefinedVariables.getInstance().SETTING_COM_VFD_CONNECT);
