 ...
 */
package pos_client.fxml.special;
...
public class SpecialController implements Initializable
{
    ...
    public void createCategories()
    {
        ...
        categoryHandler.createCategories(tabPane, anchMain, flowMap, CategoryHandler.CategoryType.SPECIAL);
    }
}
